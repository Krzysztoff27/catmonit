export const dummies = {
    ...
    alerts: {
        "1": {
            ...
            mask: "24",
            path: "/dev/sdc",
            message: "Storage below 10% on /dev/sdc",
            isWarning: true,
            type: "storage",
        },
        "2": {
            ...
            mask: "24",
            path: "/mnt/shareC",
            message: "Storage below 10% on /mnt/shareC",
            isWarning: true,
            type: "fileShares",
        },
        "3": {
            ...
            mask: "25",
            path: "/dev/sec",
            message: "Storage below 5% on /dev/sec",
            isWarning: false,
            type: "storage",
        },
        "4": {
            ...
            mask: "25",
            path: "/srv/files/public/private/public/private",
            message: "Storage below 5% on deeply nested share",
            isWarning: false,
            type: "fileShares",
        },
        "5": {
            ...
            mask: "26",
            path: "/dev/ultra3",
            message: "Storage below 10% on /dev/ultra3",
            isWarning: true,
            type: "storage",
        },
        "6": {
            ...
            ip: "192.168.1.4",
            mask: "26",
            path: "/srv/samba/ultra/share5",
            message: "Storage below 10% on /srv/samba/ultra/share5",
            isWarning: true,
            type: "fileShares",
        },
        "7": {
            ...
            mask: "24",
            path: "System",
            message: "CPU usage above 90% on Kamel",
            isWarning: false,
            type: "system",
        },
        "8": {
            ...
            mask: "25",
            path: "System",
            message: "Swap usage above 80% on Bro",
            isWarning: true,
            type: "system",
        },
    },
